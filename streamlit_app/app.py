...
st.markdown(
    """
    <div class="welcome">
        <h1>Welcome to My Personalized AI Query Assistant</h1>
        <p>An AI assistant designed for fast and insightful responses to your queries.</p>
        <p class="smaller">Type your query below and let the chatbot provide you with insights!</p>
    </div>
    """,
    unsafe_allow_html=True
)
